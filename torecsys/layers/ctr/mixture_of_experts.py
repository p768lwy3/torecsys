...
class MixtureOfExpertsLayer(nn.Module):
    r"""Layer class of Mixture-of-Experts (MoE), which is to combine outputs of serveral models, 
    ...
    #. `Robert A. Jacobs et al, 1991. Adaptive Mixtures of Local Experts <https://www.cs.toronto.edu/~hinton/absps/jjnh91.pdf>_.
